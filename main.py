...
class MainApp(App):
    ...
    def show_contact_popup(self, *args):
        ...
        contacts = [
            ("Telagram", "https://t.me/kanalCornix"),
            ("Rubika", "http://rubika.ir/cornix_2026"),
            ("Mobile Number : 09944194262", "tel:09944194262"),
            ("Instagram", "https://instagram.com/cornixsistem")
        ]
        
        for text, url in contacts:
            btn = PlasticButton(text=text, btn_color=[0.18, 0.65, 0.28, 1], size_hint_y=None, height=dp(42))
        ...
        if self.soil_contaminated:
            ...
            for idx, circ in enumerate(self.detected_circles):
                ...
                if can_draw_skeleton:
                    ...
                    pointer_y_away = (dy_sign * 0.7) / mag if mag > 0 else 0
    ...
    def find_all_picture_files(self):
        found_files = {}
        target_dirs = []
    ...
    def recall_memory_with_location(self, is_internal):
        fourprop_files_map = self.find_all_scan_files()
    ...
    def recall_jpeg_with_location(self, is_internal):
        files_map = self.find_all_picture_files()
